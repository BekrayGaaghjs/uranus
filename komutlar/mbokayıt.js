...
exports.run = (client, message, args) => {
  ...
  if (!args[0])
    return message.reply(
      "**Hoşgeldin Kayıt Olduktan Sonra Kuralları Okumayı Unutma** <@&787242203859648533> <@&787242203859648532> <@&787242203856109587> <@&787242203856109586> <@&787242203859648534>"
    );
};
exports.conf = {
  enabled: true,
